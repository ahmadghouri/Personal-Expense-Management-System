      ...
      <table class="min-w-full text-sm">
        <thead class="bg-slate-50 text-slate-700 border-b border-slate-200">
          <tr>
            ...
            <th class="px-4 py-3 text-center font-semibold">Proof</th>
        ...
        <tbody class="divide-y divide-slate-100">
          ...
          >
            ...
            <td class="px-4 py-3 text-right font-semibold text-slate-900">
              Rs. {{ parseFloat(donation.amount).toLocaleString() }}
            </td>

            <td class="px-4 py-3 text-center">
              <div v-if="donation.proof" class="text-xs text-blue-500">
                <a :href="`${baseUrl}/${donation.proof}`" target="_blank" class="underline">View</a>
              </div>
